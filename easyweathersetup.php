...
<center> <div class="modal-buttons">
     <input name="passwd" type="password" class="input-button"/>  <input type="submit" name="submit_pwd" value="Login " class="modal-button" /> 
      ...
      <?php echo "2015-" ;?><?php echo date('Y');?> &copy;</a> WEATHER34 weeWX DASHBOARD W34-WX</span></span></span>
      <br><br>
...
<div span style="width:390px;margin:0 auto;margin-top:10px;text-align:center;color:#fff;background:rgba(24, 25, 27, 0.8);font-family:arial;padding:20px;border-radius:4px;"> 
<img src='img/easyweathersetupweather34.svg' width='220px'>
<br>
...
<div class="weatheroptions">
  ...
  Setup Unique Easyweewxsetup Password</div><p>

  
  <div class= "stationvalue">  Set Easyweewxsetup Password it is for your privacy & protection</div>
...
<div class="weatheroptions">
  ...
  Database settings (only for <strong>MySQL</strong> not required for weeWX default SQLite database )</div><p>
...
<br>
 ...
 <label name="language"></label>
   ...
   <div class="weatheroptionssidebar">
   <svg id="i-info" viewBox="0 0 32 32" width="10" height="10" fill="rgba(24, 25, 27, 0.8)" stroke="rgba(24, 25, 27, 0.8)" stroke-linecap="round" stroke-linejoin="round" stroke-width="16.25%">
     <path d="M16 14 L16 23 M16 8 L16 10" /><circle cx="16" cy="16" r="14" /></svg>  Live Data 
...
WEEWX Software Path to Data file</div><p>
  ...
  <br><br>
    ...
    <strong><svg id="i-info" viewBox="0 0 32 32" width="10" height="10" fill="rgba(24, 25, 27, 0.8)" stroke="rgba(24, 25, 27, 0.8)" stroke-linecap="round" stroke-linejoin="round" stroke-width="16.25%">
     <path d="M16 14 L16 23 M16 8 L16 10" /><circle cx="16" cy="16" r="14" /></svg></strong><span style="color:#777;"> new weeWX path default is: /var/www/html/weewx/realtime.txt</span><br>
    ...
    <strong> <svg id="i-info" viewBox="0 0 32 32" width="10" height="10" fill="#FF793A" stroke="#FF793A" stroke-linecap="round" stroke-linejoin="round" stroke-width="16.25%">
     <path d="M16 14 L16 23 M16 8 L16 10" /><circle cx="16" cy="16" r="14" /></svg> getting the path correct is essential for live realtime display</strong></span>
<p>
...
weeWX Chart Data Source</div><p>
 ...
 <label name="chartsource"></label>
    ...
    <span style="color:rgba(86, 95, 103, 1.000)">
    <strong> <svg id="i-info" viewBox="0 0 32 32" width="10" height="10" fill="#FF793A" stroke="#FF793A" stroke-linecap="round" stroke-linejoin="round" stroke-width="16.25%">
     <path d="M16 14 L16 23 M16 8 L16 10" /><circle cx="16" cy="16" r="14" /></svg> choose <span style="#FF793A"><orange>wxcharts</orange></span> if you are using weeWX Database to generate chart data</strong></span>
     <br>
    <span style="color:rgba(86, 95, 103, 1.000)">
    <strong> <svg id="i-info" viewBox="0 0 32 32" width="10" height="10" fill="#FF793A" stroke="#FF793A" stroke-linecap="round" stroke-linejoin="round" stroke-width="16.25%">
     <path d="M16 14 L16 23 M16 8 L16 10" /><circle cx="16" cy="16" r="14" /></svg> choose <span style="color:rgba(24, 25, 27, 0.8)"><orange>chartswu</orange></span> if you are using your data history stored at Weather Underground</strong></span>
    ...
    <path d="M30 12 L16 24 2 12" />
       ...
       <label name="weatherhardware"></label>
        <select id="weatherhardware" name="weatherhardware" class="chooseapi">           
           ...
           <option>Fine Offset WH-2650</option>
           <option>Fine Offset </option>
...
Metar option for current ICAO weather conditions, or use Darksky Option</strong><br>
</div><p>
...
<div class="weatheroptions">
    ...
    <path d="M24 15 C21 22 16 30 16 30 16 30 11 22 8 15 5 8 10 2 16 2 22 2 27 8 24 15 Z" />
       ...
       Tell us where you are so we can convert the charts. very important  set only one box to true set all others false (important to set each option do not leave blank !!)
    </div>     <p>
        <label name="uk"></label>
...
</svg> Solar & UV Hardware, Cloudbase, Earthquake or Web Cam options</span> <br>  <br>  
<div class= "stationvalue">   
...
<br><br>
    ...
    <path d="M30 12 L16 24 2 12" />
     ...
     <path d="M16 14 L16 23 M16 8 L16 10" /><circle cx="16" cy="16" r="14" /></svg><span style="color:#777"> New option <span style="color:rgba(86, 95, 103, 1.000);">4th-October-2018</span> <span style="color:rgba(24, 25, 27, 0.8)">indoortemperature.php</span> <strong><span style="color:#777"> Shows Indoor</strong> <span style="color:#777;"> Temperature<br><br></span></span>
        
        
     <strong><svg id="i-eye" viewBox="0 0 32 32" width="14" height="14" fill="none" stroke="rgba(24, 25, 27, 0.8)" stroke-linecap="round" stroke-linejoin="round" stroke-width="10%">
...
<strong><svg id="i-info" viewBox="0 0 32 32" width="10" height="10" fill="#F75C46" stroke="#F75C46" stroke-linecap="round" stroke-linejoin="round" stroke-width="16.25%">
     ...
     <strong><svg id="i-info" viewBox="0 0 32 32" width="10" height="10" fill="#F75C46" stroke="#F75C46" stroke-linecap="round" stroke-linejoin="round" stroke-width="16.25%">
     <path d="M16 14 L16 23 M16 8 L16 10" /><circle cx="16" cy="16" r="14" /></svg><span style="color:#777"> New option <span style="color:rgba(24, 25, 27, 0.8)">weather34uvsolar.php</span> if you want <strong><span style="color:#777"> to use combined solar data ,uv + lux </strong> <span style="color:#777;"> information  *note you must have solar radiation and UV sensors!!!<br><br></span></span>


  <strong><svg id="i-info" viewBox="0 0 32 32" width="10" height="10" fill="#F75C46" stroke="#F75C46" stroke-linecap="round" stroke-linejoin="round" stroke-width="16.25%">
     <path d="M16 14 L16 23 M16 8 L16 10" /><circle cx="16" cy="16" r="14" /></svg><span style="color:#777"> New option <span style="color:rgba(24, 25, 27, 0.8)">solaruvds.php</span> if you want <strong><span style="color:#77"> use to combined solar data DARK SKY UV forecast </strong> <span style="color:#777;"> information  *note you must have solar radiation sensor!!!<br><br></span></span>
     
     <strong><svg id="i-info" viewBox="0 0 32 32" width="10" height="10" fill="#F75C46" stroke="#F75C46" stroke-linecap="round" stroke-linejoin="round" stroke-width="16.25%">
     <path d="M16 14 L16 23 M16 8 L16 10" /><circle cx="16" cy="16" r="14" /></svg><span style="color:#777"> New option <span style="color:rgba(24, 25, 27, 0.8)">weatherflowuvsolar.php</span> if you want to<strong><span style="color:#77"> weather SKY Weatherflow API alongside your existing hardware </strong> <span style="color:#777;"> <br><br></span></span>
  ...
  <span style="color:#F75C46;"><svg id="i-info" viewBox="0 0 32 32" width="12" height="12" fill="none" stroke="#777" stroke-linecap="round" stroke-linejoin="round" stroke-width="2">
    ...
    <path d="M30 12 L16 24 2 12" />
     ...
     <path d="M16 14 L16 23 M16 8 L16 10" /><circle cx="16" cy="16" r="14" /></svg><span style="color:#777;"> temperatureyear.php</span> *English only<span style="color:rgba(24, 25, 27, 0.8)"> Current Monthly / Yearly Temperature </span> <br>
      ...
      <span style="color:#777;"><svg id="i-info" viewBox="0 0 32 32" width="10" height="10" fill="rgba(24, 25, 27, 0.8)" stroke="rgba(24, 25, 27, 0.8)" stroke-linecap="round" stroke-linejoin="round" stroke-width="16.25%">
     <path d="M16 14 L16 23 M16 8 L16 10" /><circle cx="16" cy="16" r="14" /></svg><span style="color:#777;"> boltek.php.php</span> *English only<span style="color:rgba(24, 25, 27, 0.8)"> If you have a Boltek/Nexstorm </span> <br>
     <span style="color:#777;"><svg id="i-info" viewBox="0 0 32 32" width="10" height="10" fill="rgba(24, 25, 27, 0.8)" stroke="rgba(24, 25, 27, 0.8)" stroke-linecap="round" stroke-linejoin="round" stroke-width="16.25%">
     <path d="M16 14 L16 23 M16 8 L16 10" /><circle cx="16" cy="16" r="14" /></svg><span style="color:#777;"> earthquake.php</span> Totals <span style="color:rgba(24, 25, 27, 0.8)">Earthquakes</span> Latest<br></span>
...
<input name="sunpositionbearing" type="text" id="sunpositionbearing" value="<?php echo $sunpositionbearing ;?>" class="choose">
 ...
 <br>
        <svg id="i-info" viewBox="0 0 32 32" width="10" height="10" fill="rgba(24, 25, 27, 0.8)" stroke="rgba(24, 25, 27, 0.8)" stroke-linecap="round" stroke-linejoin="round" stroke-width="16.25%">
     <path d="M16 14 L16 23 M16 8 L16 10" /><circle cx="16" cy="16" r="14" /></svg> <strong> This allows you to fine tune the sun position to be relative to your location . values can be negative i.e -10,-60,-100,-150 and  0 - 300 just play around until you find a figure that shows the sun in a relative position overhead to your location . </strong><br>
...
<select id="sunoption" name="sunoption" class="choose1">
        ...
        <br>
        <svg id="i-info" viewBox="0 0 32 32" width="10" height="10" fill="rgba(24, 25, 27, 0.8)" stroke="rgba(24, 25, 27, 0.8)" stroke-linecap="round" stroke-linejoin="round" stroke-width="16.25%">
     <path d="M16 14 L16 23 M16 8 L16 10" /><circle cx="16" cy="16" r="14" /></svg> <strong> three options sun1.php works universal at all latitudes less info, sun2.php is for northern hemisphere only and has additional info. **very beta try sun3.php if in northern hemisphere i.e above 0 latitude slimmed down idea based on Wim version for WD 
 </strong><br>
  ...
  <label name="minmag" ></label>
   <svg id="i-chevron-right" viewBox="0 0 32 32" width="14" height="14" fill="none" stroke="rgba(86, 95, 103, 1.000)" stroke-linecap="round" stroke-linejoin="round" stroke-width="6.25%">
    ...
    <path d="M30 12 L16 24 2 12" />
     ...
     <br><br>
   <div class= "stationvalue">Show Earthquake module?</div> <svg id="i-chevron-right" viewBox="0 0 32 32" width="14" height="14" fill="none" stroke="rgba(86, 95, 103, 1.000)" stroke-linecap="round" stroke-linejoin="round" stroke-width="6.25%">
    <path d="M12 30 L24 16 12 2" />
</svg><svg id="i-chevron-bottom" viewBox="0 0 32 32" width="10" height="10" fill="#777" stroke="#777" stroke-linecap="round" stroke-linejoin="round" stroke-width="6.25%">
    <path d="M30 12 L16 24 2 12" />
</svg>
...
<path style="fill:rgba(86, 95, 103, 1.000);stroke:#ccc;stroke-width:0.0938;" d="M536.9,99.9c6.8,5.2,12.7,11.6,19.2,17.2
...
Show fire risk level or feels like icon</div> <svg id="i-chevron-right" viewBox="0 0 32 32" width="14" height="14" fill="none" stroke="rgba(86, 95, 103, 1.000)" stroke-linecap="round" stroke-linejoin="round" stroke-width="6.25%">
    <path d="M12 30 L24 16 12 2" />
</svg><svg id="i-chevron-bottom" viewBox="0 0 32 32" width="10" height="10" fill="#777" stroke="#777" stroke-linecap="round" stroke-linejoin="round" stroke-width="6.25%">
    <path d="M30 12 L16 24 2 12" />
</svg>
<label name="fireriskshow"></label>
     ...
     <span style="color:rgba(86, 95, 103, 1.000);"><svg id="i-info" viewBox="0 0 32 32" width="10" height="10" fill="rgba(24, 25, 27, 0.8)" stroke="rgba(24, 25, 27, 0.8)" stroke-linecap="round" stroke-linejoin="round" stroke-width="16.25%">
...
<div class= "stationvalue">Do you have Weatherflow Station</div> <svg id="i-chevron-right" viewBox="0 0 32 32" width="14" height="14" fill="none" stroke="rgba(86, 95, 103, 1.000)" stroke-linecap="round" stroke-linejoin="round" stroke-width="6.25%">
  ...
  <br>
    ...
    <path d="M16 14 L16 23 M16 8 L16 10" />
    <circle cx="16" cy="16" r="14" />
</svg> <span style="color:#777;">(option works when available weatherflow is connected to meteobridge) select yes if you wish to display lightning module *do not select yes if you want to display Purple Air module option below .simply template area has been exhausted</span></span>
...
<span style="color:#F75C46;"><svg id="i-info" viewBox="0 0 32 32" width="12" height="12" fill="none" stroke="#777" stroke-linecap="round" stroke-linejoin="round" stroke-width="2">
    ...
    <path d="M16 14 L16 23 M16 8 L16 10" />    <circle cx="16" cy="16" r="14" /></svg> *option temperature.php default without indoor temperature displayed<br>
          <svg id="i-info" viewBox="0 0 32 32" width="12" height="12" fill="none" stroke="#777" stroke-linecap="round" stroke-linejoin="round" stroke-width="2">
    <path d="M16 14 L16 23 M16 8 L16 10" />    <circle cx="16" cy="16" r="14" /></svg> *option2 temperaturein.php displays indoor temperture in small circle bottom left of temperature module.Do not use if using indoor option below .</span>
  <div class="seperator"></div>
...
</svg> *new 12th June 2018</span><span style="color:#777;"> Indoor Sensor optional module choose false if you have Purple Air Quality Hardware option below ,Weatherflow Lightning option above or false if you want to display moonphase info</span> <br>  
...
<br>
   <p>      
    ...
    <path d="M16 14 L16 23 M16 8 L16 10" />
    <circle cx="16" cy="16" r="14" />
</svg> <span style="color:#777;">enter your <strong>PurpleAir </strong> station id example <strong><span style="color:rgba(86, 95, 103, 1.000);"> 1200</strong>*note you can not run Purple Air Module with Weatherflow Lightning.simply template area has been exhausted</span></span>
...
<svg id="i-checkmark" viewBox="0 0 32 32" width="12" height="12" fill="none" stroke="currentcolor" stroke-linecap="round" stroke-linejoin="round" stroke-width="6.25%">
    ...
    <path d="M16 14 L16 23 M16 8 L16 10" />
    <circle cx="16" cy="16" r="14" />
</svg> weeWX DASHBOARD EASY SETUP &copy; 2015-<?php echo date('Y');?> Dashboard </span><br>
<center><a href="httsp://weewx.com" title="https://weewx.com" target="_blank"><img src="img/weewx.svg" width="40" /></a></center><br>
