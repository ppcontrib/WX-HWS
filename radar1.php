...
<iframe width="820" height="400" src="https://embed.windy.com/embed2.html?lat=<?php echo $lat ;?>&lon=<?php echo $lon ;?>&zoom=6&level=surface&overlay=clouds&menu=&message=&marker=&forecast=12&calendar=now&location=coordinates&type=map&actualGrid=&metricWind=kt&metricTemp=%C2%B0C" frameborder="0"></iframe>
